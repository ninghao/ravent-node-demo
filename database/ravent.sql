...
--
-- Database: ravent
-- Generation Time: 2020-07-14 09:37:56.8620
-- -------------------------------------------------------------
...
CREATE TABLE `post_tag` (
  ...
  CONSTRAINT `post_tag_ibfk_2` FOREIGN KEY (`postId`) REFERENCES `post` (`id`)
